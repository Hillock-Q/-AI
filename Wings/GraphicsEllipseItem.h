...
class CGraphicsEllipseItem : public QObject, public QGraphicsEllipseItem, public CItemInfo
{
    Q_OBJECT

public:
    enum {Type = UserType + 2};
    CGraphicsEllipseItem(bool edit, int sn, qreal x, qreal y, qreal width, qreal height, QString const &netId, QString const &netName, QColor const &color, QGraphicsItem *parent = nullptr);
    CGraphicsEllipseItem(bool edit, int sn, const QRectF &rect, QString const &netId, QString const &netName, QColor const &color, QGraphicsItem *parent = nullptr);
    CGraphicsEllipseItem(bool edit, int sn, QString const &netId, QString const &netName, QColor const &color, QGraphicsItem *parent = nullptr);

    virtual ~CGraphicsEllipseItem() override;
